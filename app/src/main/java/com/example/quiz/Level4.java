...
public class Level4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog.setContentView(R.layout.previewdialogfour);
        ...
        final Animation a = AnimationUtils.loadAnimation(Level4.this,R.anim.alhpa);
        // код подключения анимации-конец
        numLeft = random.nextInt(10);
        imgLeft.setImageResource(array.images4[numLeft]);//достаем из массива картинку
        text_left.setText(array.texts4[numLeft]);//достаем ткст из массива
