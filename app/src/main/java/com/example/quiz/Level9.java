...
public class Level9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog.setContentView(R.layout.previewdialognine);
        ...
        final Animation a = AnimationUtils.loadAnimation(Level9.this,R.anim.alhpa);
        // код подключения анимации-конец
        numLeft = random.nextInt(20);
        imgLeft.setImageResource(array.images9[numLeft]);//достаем из массива картинку
        text_left.setText(array.texts9[numLeft]);//достаем ткст из массива
