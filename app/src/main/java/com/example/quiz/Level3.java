...
public class Level3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog.setContentView(R.layout.previewdialogthree);
        ...
        final Animation a = AnimationUtils.loadAnimation(Level3.this,R.anim.alhpa);
        // код подключения анимации-конец
        numLeft = random.nextInt(10);
        imgLeft.setImageResource(array.images3[numLeft]);//достаем из массива картинку
        text_left.setText(array.texts3[numLeft]);//достаем ткст из массива
