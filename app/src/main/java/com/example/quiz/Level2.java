...
public class Level2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog.setContentView(R.layout.previewdialogtwo);//было two
        ...
        final Animation a = AnimationUtils.loadAnimation(Level2.this,R.anim.alhpa);
        // код подключения анимации-конец
        numLeft = random.nextInt(10);
        imgLeft.setImageResource(array.images2[numLeft]);//достаем из массива картинку
        text_left.setText(array.texts2[numLeft]);//достаем ткст из массива
