...
public class Level7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog.setContentView(R.layout.previewdialogseven);
        ...
        btncontinue2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Level7.this,Level8.class);// improve to 8 then
                startActivity(intent);
                finish();
                dialogEnd.dismiss();
            }
        ...
        final Animation a = AnimationUtils.loadAnimation(Level7.this,R.anim.alhpa);
        // код подключения анимации-конец
        numLeft = random.nextInt(10);
        imgLeft.setImageResource(array.images7[numLeft]);//достаем из массива картинку
        text_left.setText(array.texts7[numLeft]);//достаем ткст из массива
