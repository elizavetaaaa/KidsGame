...
public class Level8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog.setContentView(R.layout.previewdialogeight);
        ...
        btncontinue2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Level8.this,Level9.class);// improve to 8 then
                startActivity(intent);
                finish();
                dialogEnd.dismiss();
            }
        ...
        final Animation a = AnimationUtils.loadAnimation(Level8.this,R.anim.alhpa);
        // код подключения анимации-конец
        numLeft = random.nextInt(10);
        imgLeft.setImageResource(array.images8[numLeft]);//достаем из массива картинку
        text_left.setText(array.texts8[numLeft]);//достаем ткст из массива
